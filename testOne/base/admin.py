...
from .models import Assesment, Batch, Competency, CourseAssesment,PeopleByleaderforAssesment, Leader, Learner, Question, SlotForCoach,AdminRequest,Coach,Profile,ConfirmedSlotsbyCoach,Events,LeanerConfirmedSlots, SubCompetency
...
admin.site.register(PeopleByleaderforAssesment)
