    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, default='Request -', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('SESSION_START_TIME', models.CharField(blank=True, default='null', max_length=2000)),
                ('SESSION_END_TIME', models.CharField(blank=True, default='null', max_length=2000)),
                ('SESSION_DATE', models.CharField(blank=True, default='null', max_length=2000)),
                ('COACH_NAME', models.CharField(blank=True, default='null', max_length=2000)),
                ('DESCRIPTION', models.CharField(blank=True, default='null', max_length=2000)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_id', models.CharField(default='0000', max_length=200)),
                ('isActive', models.BooleanField(default=False)),
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='base.coursecategorys')),
            ],
        ),
        migrations.CreateModel(
            name='DayTimeSlot',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(default='7880647282', max_length=1000)),
        ...
        migrations.AddField(
            ...
            name='assigned_coach',
            field=models.ManyToManyField(related_name='Coach', to='base.Coach'),
        ),
        migrations.AddField(
            model_name='adminrequest',
            name='confirmed_coach',
            field=models.ManyToManyField(blank=True, related_name='confirmed_coach', to='base.Coach'),
        ),
    ]
