...
urlpatterns = [
    ...
    path('events-and-slots-by-batch/<str:batch>/',
         views.getEventsAndSlotsByBatch),
    path('approve-service-approval/<str:id>/', views.approveServiceApproval),
    path('purchase-order/', views.createPurchaseOrder),
    path('edit-purchase-order/<str:po_id>/', views.editPurchaseOrder),
    path('update-purchase-order-status/<str:po_id>/',
         views.updatePurchaseOrderStatus),
    path('read-purchase-order/', views.getpurchaseOrder),
    path('create-service-approval/', views.createServiceApproval),
    path('read-service-approval/', views.getServiceApproval),
    path('reject-service-approval/<str:id>/', views.rejectServiceApproval),
    path('approve-service-approval-by-finance/<str:id>/',
         views.approveServiceApprovalByFinance),
    path('read-reject/', views.getRejected),
    path('edit-service-approval/<str:id>/', views.editServiceapproval),
    path('get-purchased-order-by-coach/<str:coach_id>/',
         views.getPurchaseOrderByCoach),
    path('get-purchased-order-by-status/<str:status>/',
    ...
    path('get-learner-confirmed-slots-by-service-approval/<str:id>/',
         views.getLearnerConfirmedSlotsByServiceApproval),
    path('get-service-approval-by-po/', views.getServiceApprovalByPO),
    path('get-service-approval-by-coach/<str:coach_id>/',
         views.getServiceApprovalBycoach),
